...
public class FilterUtils {
    ...
    public static final String PRE_FILTER_TYPE   = "pre"; // 前置过滤器
    public static final String POST_FILTER_TYPE  = "post"; // 后置过滤器
    public static final String ROUTE_FILTER_TYPE = "route"; // 路由过滤器
